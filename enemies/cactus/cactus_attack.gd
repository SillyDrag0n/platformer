...
var bullet_impact_effect = preload("res://enemies/_common/bullet/bullet_impact_effect.tscn")
...
func _attack_on_hurtbox_area_entered(_area:Area2D) -> void:
	print("Enemy attack entered area")
	bullet_impact()

func _attack_on_hurtbox_body_entered(_body:Node2D) -> void:
